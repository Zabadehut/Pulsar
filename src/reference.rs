...
const CATALOG: &[ReferenceEntry] = &[
    ...
    ReferenceEntry {
        ...
        fr: ReferenceText {
            ...
            expert: "Sysray derive ce score a partir de la memoire disponible, de l'usage et des compteurs associes.",
        },
        en: ReferenceText {
            ...
            expert: "Sysray derives this score from available memory, usage and related counters.",
        },
    },
    ReferenceEntry {
        id: "memory.swap",
    ...
    ReferenceEntry {
        ...
        fr: ReferenceText {
            ...
            expert: "Sysray la derive des compteurs de temps et d'IO completes, utile avec util% et queue depth.",
        },
        en: ReferenceText {
            title: "Disk await",
            summary: "Average latency observed per completed IO.",
            beginner: "Higher values mean disk operations take longer to finish.",
            expert: "Sysray derives it from IO completion and timing counters; read it with util% and queue depth.",
        },
    },
    ReferenceEntry {
        id: "disk.queue_depth",
    ...
    ReferenceEntry {
        ...
        fr: ReferenceText {
            ...
            summary: "Indique comment Sysray classe le disque: bloc, namespace, mapper, volume logique ou autre.",
        ...
        en: ReferenceText {
            ...
            summary: "Shows how Sysray classifies the disk: block, namespace, mapper, logical volume or similar.",
    ...
    ReferenceEntry {
        ...
        fr: ReferenceText {
            ...
            expert: "Etend Sysray au-dela de la simple observabilite host.",
        },
        en: ReferenceText {
            ...
            expert: "Extends Sysray beyond simple host observability.",
        },
    },
    ReferenceEntry {
        id: "system.identity",
    ...
    ReferenceEntry {
        ...
        fr: ReferenceText {
            ...
            summary: "Regroupe les modes TUI, CLI, API et exports deja disponibles dans Sysray.",
        ...
        en: ReferenceText {
            ...
            summary: "Groups the TUI, CLI, API and export surfaces already available in Sysray.",
